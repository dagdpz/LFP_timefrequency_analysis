function [noisy_lfp_trials] = lfp_tfa_reject_noisy_lfp( sites_lfp_folder, cfg_noise )
...
%             end
        ...
        site.ntrails = length(site.trials);
        site.noisytrails = sum(noisy_trials);

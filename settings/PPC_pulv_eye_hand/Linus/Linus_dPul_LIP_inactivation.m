...
lfp_tfa_cfg.version = 'Linus_dPul_LIP_inactivation';
...
if ~lfp_tfa_cfg.process_LFP
    lfp_tfa_cfg.proc_lfp_folder = ...
        'Y:\Projects\PPC_pulv_eye_hand\LFP\Linus_dPul_LIP_inactivation\Processed LFP';
end
...
if ~lfp_tfa_cfg.compute_site_average
    lfp_tfa_cfg.analyse_lfp_folder = ...
        'Y:\Projects\PPC_pulv_eye_hand\LFP\Linus_dPul_LIP_inactivation\LFP Analysis';
end

...
%lfp_tfa_cfg.info_filepath = 'Y:\Projects\Simultaneous_dPul_PPC_recordings\ephys\dPul_inj_LIP_Bac_20201112\Bac_sorted_neurons.xls';
...
% used for analysis
%lfp_tfa_cfg.use_datasets = [10]; % is it used??
...
lfp_tfa_cfg.analyse_states = {'single', lfp_tfa_states.CUE_ON,    'Cue',      -1.0,   2.1};
...
lfp_tfa_cfg.analyse_epochs = {lfp_tfa_states.FIX_HOL, 'Fix', -1.0, 0;...
                                lfp_tfa_states.CUE_ON, 'Cue', 0, 0.2;...
                                lfp_tfa_states.MEM_PER, 'Delay', 0.2, 1.2;...
                                lfp_tfa_states.SAC_INI, 'Sac', 1.2, 2.1};
...
lfp_tfa_cfg.trialinfo.start_state = lfp_tfa_states.FIX_HOL;
...
lfp_tfa_cfg.trialinfo.end_state = lfp_tfa_states.SAC_INI;
...
% 1. lfp_tfa_cfg.trialinfo.ref_tend = -0.5;
% trial start time = onset time of lfp_tfa_cfg.trialinfo.end_state - 0.5;
lfp_tfa_cfg.trialinfo.ref_tend = 0.9;

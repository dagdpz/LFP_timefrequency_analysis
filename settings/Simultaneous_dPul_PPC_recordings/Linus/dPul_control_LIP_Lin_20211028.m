...
lfp_tfa_cfg.version = 'dPul_control_LIP_Lin_20211028';
...
if ~lfp_tfa_cfg.compute_site_average
    lfp_tfa_cfg.analyse_lfp_folder = ...
        'Y:\Projects\Simultaneous_dPul_PPC_recordings\LFP\dPul_control_LIP_Lin_20211028\LFP Analysis';
end

% sorted neurons excel file, from which information about sessions and
% individual sites can be obtained
lfp_tfa_cfg.info_filepath = 'Y:\Projects\Simultaneous_dPul_PPC_recordings\ephys\dPul_control_LIP_Lin_20211028\Lin_sorted_neurons.xls';
...
%       be combined)
    ...
    struct('Monkey',        'Lin', ...
           'Date',          '20211028', ...
           'Input',         'Y:\Projects\Simultaneous_dPul_PPC_recordings\ephys\dPul_control_LIP_Lin_20211028\sites_Linus_20211028.mat', ...
           'Preinj_blocks',  10, ...
           'Postinj_blocks', 12);

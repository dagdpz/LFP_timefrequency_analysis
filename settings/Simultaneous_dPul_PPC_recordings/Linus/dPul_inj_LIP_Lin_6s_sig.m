...
lfp_tfa_cfg.version = 'dPul_inj_LIP_Lin_6s_sig';
...
if ~lfp_tfa_cfg.process_LFP
    lfp_tfa_cfg.proc_lfp_folder = ...
        '~/fileserver/Projects/Simultaneous_dPul_PPC_recordings/LFP/dPul_inj_LIP_Lin_6s_sig/Processed LFP';
end
...
if ~lfp_tfa_cfg.compute_site_average
    lfp_tfa_cfg.analyse_lfp_folder = ...
        '~/fileserver/Projects/Simultaneous_dPul_PPC_recordings/LFP/dPul_inj_LIP_Lin_6s_sig/LFP Analysis';
end

% sorted neurons excel file, from which information about sessions and
% individual sites can be obtained
lfp_tfa_cfg.info_filepath = '~/fileserver/Projects/Simultaneous_dPul_PPC_recordings/ephys/dPul_inj_LIP_Lin_6s_sig/Lin_sorted_neurons.xls';
...
%            'Postinj_blocks', [2 3]);
    ...
    struct('Monkey',        'Lin', ...
           'Date',          '20210610', ...
           'Input',         '~/fileserver/Projects/Simultaneous_dPul_PPC_recordings/ephys/dPul_inj_LIP_Lin_6s_sig/sites_Linus_20210610.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', [2]);
%        
...
%            'Postinj_blocks', [2 3]);
    ...
    struct('Monkey',        'Lin', ...
           'Date',          '20210709', ...
           'Input',         '~/fileserver/Projects/Simultaneous_dPul_PPC_recordings/ephys/dPul_inj_LIP_Lin_6s_sig/sites_Linus_20210709.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', [2]);
...
%            'Postinj_blocks', [2 3]);
    ...
    struct('Monkey',        'Lin', ...
           'Date',          '20211006', ...
           'Input',         '~/fileserver/Projects/Simultaneous_dPul_PPC_recordings/ephys/dPul_inj_LIP_Lin_6s_sig/sites_Linus_20211006.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', [2]);
%        
...
%            'Postinj_blocks', [2 3]);
    ...
    struct('Monkey',        'Lin', ...
           'Date',          '20211126', ...
           'Input',         '~/fileserver/Projects/Simultaneous_dPul_PPC_recordings/ephys/dPul_inj_LIP_Lin_6s_sig/sites_Linus_20211126.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', [2]);
    ...
    struct('Monkey',        'Lin', ...
           'Date',          '20211201', ...
           'Input',         '~/fileserver/Projects/Simultaneous_dPul_PPC_recordings/ephys/dPul_inj_LIP_Lin_6s_sig/sites_Linus_20211201.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', [2]);
    ...
    struct('Monkey',        'Lin', ...
           'Date',          '20211208', ...
           'Input',         '~/fileserver/Projects/Simultaneous_dPul_PPC_recordings/ephys/dPul_inj_LIP_Lin_6s_sig/sites_Linus_20211208.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', [2]);

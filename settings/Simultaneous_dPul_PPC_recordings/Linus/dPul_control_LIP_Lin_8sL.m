...
lfp_tfa_cfg.version = 'dPul_control_LIP_Lin_8sL';
...
if ~lfp_tfa_cfg.process_LFP
    lfp_tfa_cfg.proc_lfp_folder = ...
        '~/fileserver/Projects/Simultaneous_dPul_PPC_recordings/LFP/dPul_control_LIP_Lin_8sL/Processed LFP';
end
...
if ~lfp_tfa_cfg.compute_site_average
    lfp_tfa_cfg.analyse_lfp_folder = ...
        '~/fileserver/Projects/Simultaneous_dPul_PPC_recordings/LFP/dPul_control_LIP_Lin_8sL/LFP Analysis';
end

% sorted neurons excel file, from which information about sessions and
% individual sites can be obtained
lfp_tfa_cfg.info_filepath = '~/fileserver/Projects/Simultaneous_dPul_PPC_recordings/ephys/dPul_control_LIP_Lin_8sL/Lin_sorted_neurons.xls';
...
%     struct('Monkey',        'Lin', ...
%            'Date',          '20210520', ...
%            'Input',         '~/fileserver/Projects/Simultaneous_dPul_PPC_recordings/ephys/dPul_inj_LIP_Lin_8s/sites_Linus_20210520.mat', ...
%            'Preinj_blocks',  0, ...
%            'Postinj_blocks', [2 3]);
    ...
    struct('Monkey',        'Lin', ...
           'Date',          '20210623', ...
           'Input',         '~/fileserver/Projects/Simultaneous_dPul_PPC_recordings/ephys/dPul_control_LIP_Lin_8sL/sites_Linus_20210623.mat', ...
           'Preinj_blocks',  10, ...
           'Postinj_blocks', [12]);
    ...
    struct('Monkey',        'Lin', ...
           'Date',          '20210729', ...
           'Input',         '~/fileserver/Projects/Simultaneous_dPul_PPC_recordings/ephys/dPul_control_LIP_Lin_8sL/sites_Linus_20210729.mat', ...
             'Preinj_blocks',  10, ...
           'Postinj_blocks', [12]);
    ...
    struct('Monkey',        'Lin', ...
           'Date',          '20210910', ...
           'Input',         '~/fileserver/Projects/Simultaneous_dPul_PPC_recordings/ephys/dPul_control_LIP_Lin_8sL/sites_Linus_20210910.mat', ...
           'Preinj_blocks',  10, ...
           'Postinj_blocks', [12]);  
    ...
    struct('Monkey',        'Lin', ...
           'Date',          '20211013', ...
           'Input',         '~/fileserver/Projects/Simultaneous_dPul_PPC_recordings/ephys/dPul_control_LIP_Lin_8sL/sites_Linus_20211013.mat', ...
           'Preinj_blocks',  10, ...
           'Postinj_blocks', [12]);  
    ...
    struct('Monkey',        'Lin', ...
           'Date',          '20211028', ...
           'Input',         '~/fileserver/Projects/Simultaneous_dPul_PPC_recordings/ephys/dPul_control_LIP_Lin_8sL/sites_Linus_20211028.mat', ...
           'Preinj_blocks',  10, ...
           'Postinj_blocks', [12]);  
    ...
    struct('Monkey',        'Lin', ...
           'Date',          '20211029', ...
           'Input',         '~/fileserver/Projects/Simultaneous_dPul_PPC_recordings/ephys/dPul_control_LIP_Lin_8sL/sites_Linus_20211029.mat', ...
           'Preinj_blocks',  10, ...
           'Postinj_blocks', [12]);  
    ...
    struct('Monkey',        'Lin', ...
           'Date',          '20211203', ...
           'Input',         '~/fileserver/Projects/Simultaneous_dPul_PPC_recordings/ephys/dPul_control_LIP_Lin_8sL/sites_Linus_20211203.mat', ...
           'Preinj_blocks',  10, ...
           'Postinj_blocks', [12]);  
    ...
    struct('Monkey',        'Lin', ...
           'Date',          '20211210', ...
           'Input',         '~/fileserver/Projects/Simultaneous_dPul_PPC_recordings/ephys/dPul_control_LIP_Lin_8sL/sites_Linus_20211210.mat', ...
           'Preinj_blocks',  10, ...
           'Postinj_blocks', [12]);  

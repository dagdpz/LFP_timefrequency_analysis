...
lfp_tfa_cfg.version = 'dPul_LIP_Bac_3last_TCM';
...
if ~lfp_tfa_cfg.process_LFP
    lfp_tfa_cfg.proc_lfp_folder = ...
        'Y:\Projects\Simultaneous_dPul_PPC_recordings\LFP\dPul_LIP_Bac_3last_TCM\Processed LFP';
end
...
if ~lfp_tfa_cfg.compute_site_average
    lfp_tfa_cfg.analyse_lfp_folder = ...
        'Y:\Projects\PPC_pulv_eye_hand\LFP\dPul_LIP_Bac_3last_sessions_TCM\LFP Analysis';
end

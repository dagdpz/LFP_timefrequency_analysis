...
lfp_tfa_cfg.version = 'Magnus_dPul_control';
...
lfp_tfa_cfg.session_info(1) = ...
    struct('Monkey',             'Magnus', ...
           'Date',               '20190131', ...
           'Input_ECG_combined', 'Y:\Data\Magnus_phys_combined_monkeypsych_TDT\20190131', ...
...
%            'Postinj_blocks',     []); 
 ...
 lfp_tfa_cfg.session_info(2) = ...
    struct('Monkey',             'Magnus', ...
           'Date',               '20190213', ...
           'Input_ECG_combined', 'Y:\Data\Magnus_phys_combined_monkeypsych_TDT\20190213', ...
           'Input_ECG',          'Y:\Projects\PhysiologicalRecording\Data\Cornelius\20190227\20190227_ecg.mat', ...
           'Preinj_blocks',      [1,2,3,4,5,6], ...
           'Postinj_blocks',     []); 
       
 lfp_tfa_cfg.session_info(3) = ...
    struct('Monkey',             'Magnus', ...
           'Date',               '20190404', ...
           'Input_ECG_combined', 'Y:\Data\Magnus_phys_combined_monkeypsych_TDT\20190404', ...
...
lfp_tfa_cfg.event_triggers = {lfp_tfa_states.TAR_ACQ,   'Tar acq',    -1,   1};
...
lfp_tfa_cfg.analyse_Rpeak_states = {lfp_tfa_states.TAR_ACQ,   'Tar acq', [-0.5 0.5], 'afterRpeak'};

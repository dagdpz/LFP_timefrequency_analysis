...
lfp_tfa_cfg.version = 'LFP_decoding_MIPR_Instr_IH_IS_control_vs_inactivation';
...
lfp_tfa_cfg.decode.classes(cl).hs_label = 'IH IS';
lfp_tfa_cfg.decode.classes(cl).label = 'Instr control IHIS';
...
lfp_tfa_cfg.decode.classes(cl).choice_trial = 0;
lfp_tfa_cfg.decode.classes(cl).hs_label = 'IH IS';
lfp_tfa_cfg.decode.classes(cl).label = 'Instr inactivation IHIS';

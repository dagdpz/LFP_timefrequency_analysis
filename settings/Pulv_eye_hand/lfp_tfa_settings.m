...
lfp_tfa_cfg.version = 'Tesla_dataSet_all';
...
if ~lfp_tfa_cfg.process_LFP
    lfp_tfa_cfg.proc_lfp_folder = ...
        'Y:\Projects\Pulv_eye_hand\LFP\Tesla_dataSet_all\Processed LFP';
end
...
if ~lfp_tfa_cfg.compute_site_average
    lfp_tfa_cfg.analyse_lfp_folder = ...
        'Y:\Projects\Pulv_eye_hand\LFP\Tesla_dataSet_all\LFP Analysis';
end

% sorted neurons excel file, from which information about sessions and
% individual sites can be obtained
lfp_tfa_cfg.info_filepath = 'Y:\Projects\Pulv_eye_hand\ephys\Tesla_dataSet_all\Tes_sorted_neurons.xls';
...
lfp_tfa_cfg.session_info(1) = ...
    struct('Monkey',        'Tes', ...
           'Date',          '20170329', ...
           'Input',         'Y:\Projects\Pulv_eye_hand\ephys\Tesla_dataSet_all\sites_Tesla_20170329.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', []);
lfp_tfa_cfg.session_info(2) = ...
    struct('Monkey',        'Tes', ...
           'Date',          '20170330', ...
           'Input',         'Y:\Projects\Pulv_eye_hand\ephys\Tesla_dataSet_all\sites_Tesla_20170330.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', []);
% lfp_tfa_cfg.session_info(3) = ...
%     struct('Monkey',        'Tes', ...
%            'Date',          '20170331', ...
%            'Input',         'Y:\Projects\Pulv_eye_hand\ephys\Tesla_dataSet_all\sites_Tesla_20170331.mat', ...
%            'Preinj_blocks',  0, ...
...
lfp_tfa_cfg.session_info(3) = ...
    struct('Monkey',        'Tes', ...
           'Date',          '20170405', ...
           'Input',         'Y:\Projects\Pulv_eye_hand\ephys\Tesla_dataSet_all\sites_Tesla_20170405', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', []);
lfp_tfa_cfg.session_info(4) = ...
    struct('Monkey',        'Tes', ...
           'Date',          '20170406', ...
           'Input',         'Y:\Projects\Pulv_eye_hand\ephys\Tesla_dataSet_all\sites_Tesla_20170406', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', []);
lfp_tfa_cfg.session_info(5) = ...
    struct('Monkey',        'Tes', ...
           'Date',          '20170413', ...
           'Input',         'Y:\Projects\Pulv_eye_hand\ephys\Tesla_dataSet_all\sites_Tesla_20170413', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', []);
...
lfp_tfa_cfg.compare.targets = {'PUL_L'}; 

...
lfp_tfa_cfg.version = 'Cornelius_inactivation';
...
%            'Date',          '20190124', ...
%            'Input_ECG_raw', 'Y:\Data\Cornelius_phys_combined_monkeypsych_TDT\20190124', ...
%            'Input_ECG',     'Y:\Projects\PhysiologicalRecording\Data\Cornelius\20190124\20190124_ecg.mat', ...
%            'Preinj_blocks',  [], ...
%            'Postinj_blocks', []); 
...
lfp_tfa_cfg.session_info(1) = ...
    struct('Monkey',        'Cornelius', ...
           'Date',          '20190129', ...
           'Input_ECG_raw', 'Y:\Data\Cornelius_phys_combined_monkeypsych_TDT\20190129', ...
           'Input_ECG',     'Y:\Projects\PhysiologicalRecording\Data\Cornelius\20190129\20190129_ecg.mat', ...
           'Preinj_blocks',  [], ...
           'Postinj_blocks', []); 
...
lfp_tfa_cfg.session_info(2) = ...
    struct('Monkey',        'Cornelius', ...
           'Date',          '20190201', ...
           'Input_ECG_raw', 'Y:\Data\Cornelius_phys_combined_monkeypsych_TDT\20190201', ...
...
lfp_tfa_cfg.session_info(3) = ...
    struct('Monkey',        'Cornelius', ...
           'Date',          '20190207', ...
           'Input_ECG_raw', 'Y:\Data\Cornelius_phys_combined_monkeypsych_TDT\20190207', ...
...
lfp_tfa_cfg.session_info(4) = ...
    struct('Monkey',        'Cornelius', ...
           'Date',          '20190214', ...
           'Input_ECG_raw', 'Y:\Data\Cornelius_phys_combined_monkeypsych_TDT\20190214', ...
...
%     struct('Monkey',        'Cornelius', ...
%            'Date',          '20190228', ...
%            'Input_ECG_raw', 'Y:\Data\Cornelius_phys_combined_monkeypsych_TDT\20190228', ...
...
lfp_tfa_cfg.session_info(5) = ...
    struct('Monkey',        'Cornelius', ...
           'Date',          '20190314', ...
           'Input_ECG_raw', 'Y:\Data\Cornelius_phys_combined_monkeypsych_TDT\20190314', ...
...
%     struct('Monkey',        'Cornelius', ...
%            'Date',          '20190313', ...
%            'Input_ECG_raw', 'Y:\Data\Cornelius_phys_combined_monkeypsych_TDT\20190313', ...
%            'Input_ECG',     'Y:\Projects\PhysiologicalRecording\Data\Cornelius\20190313\20190313_ecg.mat', ...
%            'Preinj_blocks',  [1:10], ...
%            'Postinj_blocks', [11:21]); 
%        
% lfp_tfa_cfg.session_info(2) = ...
%     struct('Monkey',        'Magnus', ...
%            'Date',          '20190213', ...
...
%     struct('Monkey',        'Magnus', ...
%            'Date',          '20190208', ...
%            'Input',         {{'Y:\Projects\PPC_pulv_body_signals\ephys\MIP_control_20190208_rest\sites_Magnus_20190208.mat', ...
%                             'Y:\Projects\PPC_pulv_body_signals\ephys\MIP_control_20190208\sites_Magnus_20190208.mat'}}, ...
%            'Input_ECG',     'Y:\Projects\PhysiologicalRecording\Data\Magnus\20190208\20190208_ecg.mat', ...
...
lfp_tfa_cfg.analyse_states = {'ecg', 'ECG peak', -1, 1};

lfp_tfa_cfg.event_triggers = {lfp_tfa_states.FIX_HOL,   'Fix hold',      -1,   1;...
                              lfp_tfa_states.TAR_HOL,    'Tar hold',    -1,   1};
...
lfp_tfa_cfg.analyse_Rpeak_states = {lfp_tfa_states.TAR_HOL,   'Tar hold', 'afterRpeak'; ...
                                    lfp_tfa_states.TAR_ACQ,   'Tar acq', 'afterRpeak'};

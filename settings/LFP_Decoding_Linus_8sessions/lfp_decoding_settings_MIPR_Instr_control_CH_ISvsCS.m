...
lfp_decode_cfg.version = 'LFP_decoding_MIPR_Instr_Control_CH_ISvsCS';
...
lfp_decode_cfg.decode.nsamples_lfp_tbin = 1;
...
lfp_decode_cfg.compare.targets = {'MIP_R', 'MIP_L'}; 
...
%% Settings relevant for decoding
% The following settings are relevant only if
% lfp_decode_cfg.read_decode_LFP is true
...
%% Settings for LFP time frequency spectrogram calculations
% The following settings are relevant only if lfp_decode_cfg.process_LFP is
% true

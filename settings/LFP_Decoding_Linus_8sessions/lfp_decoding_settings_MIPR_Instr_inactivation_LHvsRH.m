...
lfp_tfa_cfg.version = 'LFP_decoding_MIPR_Instr_inactivation_LHvsRH';
...
lfp_tfa_cfg.decode.classes(cl).reach_hand = 'L';
lfp_tfa_cfg.decode.classes(cl).label = 'Instr inactivation LH';

cl = cl + 1;
lfp_tfa_cfg.decode.classes(cl).target = 'MIP_R';
lfp_tfa_cfg.decode.classes(cl).perturbation = 1;
lfp_tfa_cfg.decode.classes(cl).choice_trial = 0;
lfp_tfa_cfg.decode.classes(cl).reach_hand = 'R';
lfp_tfa_cfg.decode.classes(cl).label = 'Instr inactivation RH';

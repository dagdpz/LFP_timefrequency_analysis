...
lfp_decode_cfg.version = 'LFP_decoding_MIPL_Instr_inactivation_LHvsRH';
...
lfp_decode_cfg.decode.classes(cl).reach_hand = 'L';
lfp_decode_cfg.decode.classes(cl).label = 'Instr inactivation LH';

cl = cl + 1;
lfp_decode_cfg.decode.classes(cl).target = 'MIP_L';
lfp_decode_cfg.decode.classes(cl).perturbation = 1;
lfp_decode_cfg.decode.classes(cl).choice_trial = 0;
lfp_decode_cfg.decode.classes(cl).reach_hand = 'R';
lfp_decode_cfg.decode.classes(cl).label = 'Instr inactivation RH';

...
lfp_tfa_cfg.version = 'LFP_decoding_MIPR_Instr_inactivation_LSvsRS';
...
lfp_tfa_cfg.decode.classes(cl).reach_space = 'L';
lfp_tfa_cfg.decode.classes(cl).label = 'Instr inactivation LS';
...
lfp_tfa_cfg.decode.classes(cl).label = 'Instr inactivation RS';

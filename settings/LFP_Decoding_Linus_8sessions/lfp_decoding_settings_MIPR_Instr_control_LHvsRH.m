...
lfp_decode_cfg.version = 'LFP_decoding_MIPR_Instr_Control_LHvsRH';
...
lfp_decode_cfg.decode.classes(cl).label = 'Instr control LH';
...
lfp_decode_cfg.decode.classes(cl).label = 'Instr control RH';

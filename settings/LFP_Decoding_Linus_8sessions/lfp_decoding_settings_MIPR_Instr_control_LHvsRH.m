...
lfp_tfa_cfg.version = 'LFP_decoding_MIPR_Instr_Control_LHvsRH';
...
lfp_tfa_cfg.decode.classes(cl).label = 'Instr control LH';
...
lfp_tfa_cfg.decode.classes(cl).label = 'Instr control RH';

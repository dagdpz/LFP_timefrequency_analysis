...
lfp_decode_cfg.version = 'LFP_decoding_MIPR_Instr_Control_LSvsRS';
...
lfp_decode_cfg.decode.classes(cl).label = 'Instr control LS';
...
lfp_decode_cfg.decode.classes(cl).label = 'Instr control RS';

...
lfp_tfa_cfg.version = 'LFP_decoding_MIPR_Instr_Control_IH_ISvsCS';
...
lfp_tfa_cfg.decode.classes(cl).label = 'Instr control LS';
...
lfp_tfa_cfg.decode.classes(cl).label = 'Instr control RS';

...
lfp_tfa_cfg.version = 'Magnus_dPul_rest';
...
lfp_tfa_cfg.analyse_states = {'combined', [lfp_tfa_states.INI_TRI lfp_tfa_states.TRI_END], 0.5, 20, 'uniform'};                    

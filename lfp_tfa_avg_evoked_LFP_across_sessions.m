...
for t = 1:length(lfp_tfa_cfg.compare.targets)
    ...
    for trial_type = 1:2
        ...
        result_file = fullfile(results_fldr,['LFP_Evoked_' sessions_avg(t).target ...
            '_combined_' trial_title ]);
        
        lfp_tfa_plot_evoked_lfp_combined_accross_sessions(sessions_avg(t).condition, lfp_tfa_cfg, ...

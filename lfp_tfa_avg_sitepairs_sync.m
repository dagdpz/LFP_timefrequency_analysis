                                ...
                                if isfield(sitepair_sync.condition(cn).hs_tuned_sync(st, hs), 'ppc') ...
                                    ...
                                    if sitepairs_avg(t).condition(cn).hs_tuned_sync(st, hs).nsites == 1%~isfield(sessions_avg.cond_based_tfs(cn).tfs_across_sessions, 'powspctrm')
                                        ...
                                        sitepairs_avg(t).condition(cn).hs_tuned_sync(st, hs).csd.time ...
                                            = sitepair_sync.condition(cn).hs_tuned_sync(st, hs).csd.time;
                                        sitepairs_avg(t).condition(cn).hs_tuned_sync(st, hs).csd.freq ...
                                            = sitepair_sync.condition(cn).hs_tuned_sync(st, hs).csd.freq;                                        
                                        sitepairs_avg(t).condition(cn).hs_tuned_sync(st, hs).csd.cfg ...
                                            = sitepair_sync.condition(cn).hs_tuned_sync(st, hs).csd.cfg;
                                        sitepairs_avg(t).condition(cn).hs_tuned_sync(st, hs).csd.crsspctrm_abs_mean_norm ...
                                            = cat(1, sitepairs_avg(t).condition(cn).hs_tuned_sync(st, hs).csd.crsspctrm_abs_mean_norm, ...
                                            sitepair_sync.condition(cn).hs_tuned_sync(st, hs).csd.crsspctrm_abs_mean_norm);
                                        sitepairs_avg(t).condition(cn).hs_tuned_sync(st, hs).csd.crsspctrm_ang_mean ...
                                            = cat(1, sitepairs_avg(t).condition(cn).hs_tuned_sync(st, hs).csd.crsspctrm_ang_mean, ...
...
%                                         end
                                        ...
                                        sitepairs_avg(t).condition(cn).hs_tuned_sync(st, hs).ppc.time = ...
                                            sitepairs_avg(t).condition(cn).hs_tuned_sync(st, hs).ppc.time(1:ntimebins);
                                        sitepairs_avg(t).condition(cn).hs_tuned_sync(st, hs).ppc.ppcspctrm ...
                                        ...
                                        sitepairs_avg(t).condition(cn).hs_tuned_sync(st, hs).csd.time = ...
                                            sitepairs_avg(t).condition(cn).hs_tuned_sync(st, hs).csd.time(1:ntimebins);
                                        sitepairs_avg(t).condition(cn).hs_tuned_sync(st, hs).csd.crsspctrm_abs_mean_norm ...
                                            = cat(1, sitepairs_avg(t).condition(cn).hs_tuned_sync(st, hs).csd.crsspctrm_abs_mean_norm(:,:,1:ntimebins), ...
                                            (sitepair_sync.condition(cn).hs_tuned_sync(st, hs).csd.crsspctrm_abs_mean_norm(:,:,1:ntimebins)) ...
                                            );
                                        sitepairs_avg(t).condition(cn).hs_tuned_sync(st, hs).csd.crsspctrm_ang_mean ...
                                            = cat(1, sitepairs_avg(t).condition(cn).hs_tuned_sync(st, hs).csd.crsspctrm_ang_mean(:,:,1:ntimebins), ...
                                            (sitepair_sync.condition(cn).hs_tuned_sync(st, hs).csd.crsspctrm_ang_mean(:,:,1:ntimebins)) ...
                                            );
        ...
        for cn = 1:length(sitepairs_avg(t).condition)
                ...
                if isfield(sitepairs_avg(t).condition(cn).hs_tuned_sync, 'ppc')
                    for st = 1:size(sitepairs_avg(t).condition(cn).hs_tuned_sync, 1)
                        for hs = 1:size(sitepairs_avg(t).condition(cn).hs_tuned_sync, 2)
                            ...
                            sitepairs_avg(t).condition(cn).hs_tuned_sync(st,hs).ppc.ppcspctrm_raw = ...
                                sitepairs_avg(t).condition(cn).hs_tuned_sync(st,hs).ppc.ppcspctrm;
                            ...
                            sitepairs_avg(t).condition(cn).hs_tuned_sync(st,hs).csd.crsspctrm_abs_mean_norm_all = ...
                                sitepairs_avg(t).condition(cn).hs_tuned_sync(st,hs).csd.crsspctrm_abs_mean_norm;
                            sitepairs_avg(t).condition(cn).hs_tuned_sync(st,hs).csd.crsspctrm_abs_mean_norm = ...
                                nanmean( ...
                                sitepairs_avg(t).condition(cn).hs_tuned_sync(st,hs).csd.crsspctrm_abs_mean_norm_all, 1);
                            sitepairs_avg(t).condition(cn).hs_tuned_sync(st,hs).csd.crsspctrm_ang_mean_all = ...
                                sitepairs_avg(t).condition(cn).hs_tuned_sync(st,hs).csd.crsspctrm_ang_mean;
                            sitepairs_avg(t).condition(cn).hs_tuned_sync(st,hs).csd.crsspctrm_ang_mean = ...
                                nanmean( ...
                                sitepairs_avg(t).condition(cn).hs_tuned_sync(st,hs).csd.crsspctrm_ang_mean_all, 1);
                        end
                    end
                end
            end
            ...
            if ~isempty(sitepairs_avg(t).condition(cn).hs_tuned_sync)
                if isfield(sitepairs_avg(t).condition(cn).hs_tuned_sync,... 
                        'ppc')
                    plottitle_ppc = sprintf('LFP-LFP Sync %s - %s (ref: %s) %s', lfp_tfa_cfg.compare.target_pairs{t}{:}, ...
                        lfp_tfa_cfg.ref_hemisphere, sitepairs_avg(t).condition(cn).label);
                    result_file_ppc = fullfile(results_fldr, ...
                        sprintf('LFP-LFP_Sync_%s-%s_%s.png', lfp_tfa_cfg.compare.target_pairs{t}{:}, ...
                        sitepairs_avg(t).condition(cn).label));
                    lfp_tfa_plot_hs_tuned_sync(sitepairs_avg(t).condition(cn).hs_tuned_sync, ...
                        lfp_tfa_cfg, plottitle_ppc, result_file_ppc, 'imscale', [0, 1]);
                    ...
                    result_file_crs = fullfile(results_fldr, ...
                        ...
                        sitepairs_avg(t).condition(cn).label));
                    lfp_tfa_plot_hs_tuned_crsspctrm(sitepairs_avg(t).condition(cn).hs_tuned_sync, ...
                    ...
                    result_file_phase = fullfile(results_fldr, ...
                        sprintf('LFP-LFP_phasediff_%s-%s_%s.png', lfp_tfa_cfg.compare.target_pairs{t}{:}, ...
                        sitepairs_avg(t).condition(cn).label));
                    lfp_tfa_plot_hs_tuned_phasediff(sitepairs_avg(t).condition(cn).hs_tuned_sync, ...
                        lfp_tfa_cfg, plottitle_phase, result_file_phase, 'imscale', [-1, 1]);
            ...
            if ~isempty(sitepairs_avg(t).difference(dcn).hs_tuned_sync)
                if isfield(sitepairs_avg(t).difference(dcn).hs_tuned_sync,... 
                    ...
                    result_file = fullfile(results_fldr, ...
                        sprintf('LFP-LFP_Diffsync_%s-%s_diffcondition%s.png', lfp_tfa_cfg.compare.target_pairs{t}{:}, ...
                        num2str(dcn))); % sitepairs_avg(t).difference(dcn).label
                    ...
                    plottitle_crs = sprintf('LFP-LFP Cross spectrum %s - %s (ref: %s) %s', lfp_tfa_cfg.compare.target_pairs{t}{:}, ...
                        lfp_tfa_cfg.ref_hemisphere, sitepairs_avg(t).difference(dcn).label);
                    result_file_crs = fullfile(results_fldr, ...
                        sprintf('LFP-LFP_Diffcrsspctrm_%s-%s_diffcondition%s.png', lfp_tfa_cfg.compare.target_pairs{t}{:}, ...
                        num2str(dcn))); % sitepairs_avg(t).difference(dcn).label
                    lfp_tfa_plot_hs_tuned_crsspctrm(sitepairs_avg(t).difference(dcn).hs_tuned_sync, ...
                        lfp_tfa_cfg, plottitle_crs, result_file_crs, 'cmap', 'bluewhitered', 'imscale', [-1, 1]);
                    
                    plottitle_phase = sprintf('LFP-LFP Phase diff %s - %s (ref: %s) %s', lfp_tfa_cfg.compare.target_pairs{t}{:}, ...
                        lfp_tfa_cfg.ref_hemisphere, sitepairs_avg(t).difference(dcn).label);
                    result_file_phase = fullfile(results_fldr, ...
                        sprintf('LFP-LFP_Diffphase_%s-%s_diffcondition%s.png', lfp_tfa_cfg.compare.target_pairs{t}{:}, ...
                        num2str(dcn))); % sitepairs_avg(t).difference(dcn).label
                    lfp_tfa_plot_hs_tuned_phasediff(sitepairs_avg(t).difference(dcn).hs_tuned_sync, ...
                        lfp_tfa_cfg, plottitle_phase, result_file_phase, 'cmap', 'bluewhitered', 'imscale', [-1, 1]);
